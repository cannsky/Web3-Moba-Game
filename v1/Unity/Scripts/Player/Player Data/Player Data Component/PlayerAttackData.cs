...
public class PlayerAttackData : INetworkSerializable
{
    ...
    public void GeneratePlayerAttackData(bool isPlayerAttacking = false)
    {
        this.isPlayerAttacking = isPlayerAttacking;
    }

    public void GeneratePlayerAttackData(int playerTargetID = 0, bool isPlayerAttacking = false)
    {
        this.playerTargetID = playerTargetID;
        this.isPlayerAttacking = isPlayerAttacking;
    }

    public void GeneratePlayerAttackData(float playerLastAttackTime = 0, bool isPlayerAttacking = false)
    {
        this.playerLastAttackTime = playerLastAttackTime;
        this.isPlayerAttacking = isPlayerAttacking;
    }

    public void GeneratePlayerAttackData(int playerTargetID = 0, float playerLastAttackTime = 0, bool isPlayerAttacking = false)
    {
        this.playerTargetID = playerTargetID;
        this.playerLastAttackTime = playerLastAttackTime;
        this.isPlayerAttacking = isPlayerAttacking;
