...
public class PlayerMovementData : INetworkSerializable
{
    ...
    public void UpdateData(Vector2 playerMovementDestination, float playerMovementTime = 0, bool isMoveRequested = false, bool isMoving = false)
    {
        this.playerMovementDestination = playerMovementDestination;
        this.playerMovementTime = playerMovementTime;
        this.isMoveRequested = isMoveRequested;
        this.isMoving = isMoving;
    }
}
